...
class DQNCartPoleSolver():
    def __init__(self, n_episodes=1000, n_win_ticks=195, max_env_steps=None, gamma=1.0, epsilon=1.0, epsilon_min=0.01,
        ...
        self.model.add(Dense(24, input_dim=self.state_dim, activation='tanh'))
    ...
    def get_epsilon(self, t):
        return max(self.epsilon_min, max(self.epsilon, 1.0 - math.log10((t + 1) * self.epsilon_decay)))
    ...
    def replay(self, batch_size):
        ...
        #     target = reward
        #     states[idx, :] = state.reshape(1, self.state_dim)
        #     next_states[idx, :] = next_state.reshape(1, self.state_dim)
        #
        ...
        #     else:
        #         target[action] = reward + self.gamma * np.amax(P[idx])
        #
        #     Y[idx] = target
        #
    ...
    def run(self):
        ...
        for e in range(self.n_episodes):
            ...
            #print("epsilon at {}: {}".format(e, self.get_epsilon(e)))
